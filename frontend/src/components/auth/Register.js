            ...
            <div className='flex bg-white'>
                ...
                <div className='w-full lg:w-1/2 pt-24 md:pt-24 px-12'>
                    ...
                    <form onSubmit={(e) => handleRegister(e)}>
                        ...
                        <button onClick={(e) => handleRegister(e)} className='mt-3 w-full font-bold text-white bg-[#ff792e] border-solid border-[1px] border-[#ff792e] rounded-xl py-3 hover:bg-white hover:text-[#ff792e]'>
                            Sign Up
                        </button>
