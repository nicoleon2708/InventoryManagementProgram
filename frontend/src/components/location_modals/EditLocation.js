...
const EditLocation = () => {
    ...
    const editLocation = async (e) =>{
        ...
        if(
            ...
            setError("Please fill all fields to update location!")
        }
        ...
        await locationService.updateLocation(id, formFields)
        .then(res=>{
    ...
    const handleChangeWarehouse = (e) =>{
        setWarehouse(parseInt(e.target.value, 10))
    }
    ...
    useEffect(()=>{
        ...
        .then(res=>{
            ...
            setCurrentWarehouse(res.data.warehouse)
        })
        ...
        .then(res=>{
            ...
            const filteredData = res_data.filter((wh) => wh.id !== warehouse)
            setListWarehouse(filteredData)
        })
        .catch(err=>console.log(err))
    }, [])
    ...
    <div>
        ...
        <div className='mt-3 rounded-lg bg-white p-[20px]'>
            ...
            <div className='py-[15px]'>
                <button onClick={editLocation} className='bg-[#ff792e] mr-3 hover:opacity-80 text-white px-5 py-2 rounded-lg'>
                    Submit
                </button>
