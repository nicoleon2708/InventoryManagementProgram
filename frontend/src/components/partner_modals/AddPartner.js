    ...
    const addPartner = async (e) =>{
        ...
        if(
           ...
           !postal_code.trim()
            ...
            setError("You must fill all fields to create new partner!")
        }
        ...
        await partnerService.registerPartner(formFields)
        .then(res=>{
            toast('Add new partner successfully')
    ...
    <div>
        ...
        {error && <p className='text-red-600 font-bold'>{error}</p>}
            ...
            <div className='py-[15px]'>
                <button onClick={addPartner} className='bg-[#ff792e] mr-3 hover:opacity-80 text-white px-5 py-2 rounded-lg'>
                    Submit
                </button>
