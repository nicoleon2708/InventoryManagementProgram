            ...
            <div class="w-full flex flex-col mt-3">
                    ...
                    >
                        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full min-h-[400px] border-2  border-dashed rounded-lg cursor-pointer  hover:bg-bray-800  border-gray-600  ">
                            ...
                            {image && (<img src={image} className='w-[300px] absolute' alt='Preview of chosen image' />)}
                            {newImage && (<img src={URL.createObjectURL(newImage)} className='w-[300px] absolute' alt='Preview of chosen image' />)}
