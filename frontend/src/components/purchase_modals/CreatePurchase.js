...
const CreatePurchase = () => {
    ...
    const createPurchase = (e) =>{
        ...
        if(!sourceLocation |
            !destinationLocation)
        {
            setError('Please fill all fields to create new purchase!')
        }else{
            ...
            if(listProduct.length>0){
                ...
                setError('Please choose a product to create purchase')
            }
    ...
    <div>
        ...
        <div className='mt-3 bg-white p-[20px] rounded-lg'>
