...
const Purchase = () => {
    ...
    const fetchData = async()=>{
        try{
            ...
            const filterData = res.data.results.filter((transfer) => transfer.is_import === true)
                                ...
                                <tr key={index} className='bg-white'>
                                    ...
                                    <td className='align-middle text-center items-center text-gray-900 px-[15px] py-[20px] border-[0px] border-b-[1px] border-solid border-[#dcdfe8]'>
                                        <div className='flex items-center'>
                                            ...
                                            <FontAwesomeIcon onClick={(e)=>handleEditTransfer(purchase.id)} className='hover:opacity-80 mr-2   cursor-pointer bg-[#78C091] rounded-lg text-white  px-[8px] py-[10px]' icon={faPen} />
