...
const AddWarehouse = () => {
    ...
    const addWarehouse = async (e) =>{
        ...
        if(
            ...
            setError('You must input all fields to create a new warehouse!')
        }
        ...
        await warehouseService.createNewWarehouse(formFields)
        .then(res=>{
            toast('Warehouse has been add successfully')
    ...
    <div>
        ...
        <div className='mt-3 rounded-lg bg-white p-[20px]'>
            ...
            <div className='py-[15px] mt-3'>
                <button onClick={addWarehouse} className='bg-[#ff792e] mr-3 hover:opacity-80 text-white px-5 py-2 rounded-lg'>
                    Submit
                </button>
