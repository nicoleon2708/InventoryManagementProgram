...
class UpdatePartnerSerializer(serializers.ModelSerializer):
    ...
    def update_partner(self):
        ...
        instance.contact_name = self.validated_data.get('contact_name', instance.contact_name)
        instance.contact_phone = self.validated_data.get('contact_phone', instance.contact_phone)
